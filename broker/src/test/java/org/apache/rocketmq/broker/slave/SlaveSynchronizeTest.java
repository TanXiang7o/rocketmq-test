...
public class SlaveSynchronizeTest {
    ...
    public void testSyncAll() throws RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, MQBrokerException, InterruptedException, UnsupportedEncodingException {
        ...
        Assert.assertEquals(this.brokerController.getTopicConfigManager().getDataVersion().getStateVersion(),1);
        Assert.assertEquals(this.brokerController.getTopicQueueMappingManager().getDataVersion().getStateVersion(),1);
        Assert.assertEquals(consumerOffsetManager.getDataVersion().getStateVersion(),1);
        Assert.assertEquals(subscriptionGroupManager.getDataVersion().getStateVersion(),1);
        Assert.assertEquals(timerMetrics.getDataVersion().getStateVersion(),1);
    }

    @Test
    public void testGetMasterAddr() {
        Assert.assertEquals(slaveSynchronize.getMasterAddr(),"127.0.0.1:10911");
    }
    ...
    public void testSyncTimerCheckPoint() throws RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, MQBrokerException, InterruptedException {
        ...
        Assert.assertEquals(timerCheckpoint.getDataVersion().getStateVersion(),0);
    }
